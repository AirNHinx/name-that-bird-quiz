...
var birdImg = ['black-capped-chickadee.jpg', 'snowy-egret.jpg', 'raven.jpg', 'violet-sabrewing-hummingbird.jpg', 'puffin.jpg', 'purple-finch.jpg', 'wooduck.jpg', 'stellers-jay.jpg', 'eagle-owl.jpg', 'greater-bird-paradise.jpg']
	...
	$(".initiate").click(function() {
		...
		//$("#bird" + currentBird + ">ul>li.option" + correctBird[currentBird]).addClass("correct-bird");
		if('"#bird" + currentBird + ">ul>li.option"'.hasClass('"option" + correctBird[currentBird]')) {
			$(this).addClass("correct-bird");
		} else {
			$(this).addClass("wrong-bird");
		};
		//$("#bird" + currentBird + ">ul>li.option" + correctBird[currentBird]).addClass("correct-bird");
